...
\label{Feláldozható talpnyaló páncél}
...
\definition{Növeld meg a méretarányt}, hogy a főellenség a JK"~knál magasabb szinten működjön, ehhez használd a méretarány szabályokat az \onpage{Méretarány}. Ezt akkor is bevetheted, ha egyébként a kampányban nincs méretarány -- ezek a szabályok csak akkor lépnek érvénybe, ha a főellenség feltűnik a jelenetben.
...
A Fate játékban bármit lehet karaktereként kezelni, miért pont egy térképet ne lehetne? Ha \definition{a veszély egy térkép}, akkor a főellenség zónákból áll (\page{Zónák}), amiben navigálni kell a győzelem elérésének érdekében.
